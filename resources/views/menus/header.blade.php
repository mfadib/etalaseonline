  ...
  <div class="col-md-12">
    <div class="bgabu1" style="position: fixed; z-index: 999; width: 100%; border-bottom: 1px solid #666">
      ...
      <div class="right mt20 mr10">
        ...
        <div class="none col-xs-12 left bg5 pt20" style="width: 100%; height: 400px; z-index: 9996; border: 1px solid #ddd; position: absolute; overflow-y: scroll; margin-top: 67px; margin-left: 0" id="w_hover_s">
          ...
          <div id="hover_blog_s" class="none hover_x_s">
            ...
            <div class="col-md-2 col-sm-4">
              <div class="p10">
                ...
                <div class="p5" style="border-bottom: 1px solid #ddd;">
...
<div class="row pt20" style="border-bottom: 1px solid #ddd"></div>
...
<?php /*
    @foreach($webprofile as $web)
      <div class="row sticky-nav" id="sticky-nav">
        <div class="col-md-12">
          <div class="bg2" style="position: fixed; z-index: 999; width: 100%;">
              <img class="left mt10 ml10 bg5 rd10 p5 stc-logo" src="{{URL::asset('images/'.$web->icon)}}" style="margin-bottom: 10px">
              <div class="right mt15">
                {!! Form::open(['action'=>'ProductController@search','method'=>'post']) !!}
                <input type="text" name="search" class="p5 left" placeholder="Search Entire Store" style="width: 140px">
                <div class="bg cw left" style="text-align: center; width: 34px; height: 34px">
                  <span class="fa fa-search" style="margin-top: 10px;"></span>
                </div>
                {!! Form::close() !!}
                <div class="right" style="margin-top: -14px">
                  <button type="button" class="navbar-toggle collapsed cw" onclick="show('sticky-hid-768')">
                    <span class="sr-only">Toggle navigation</span>
                    <span class="fa fa-bars fa-2x" style="text-align: right;"></span>
                  </button>
                </div>
              ...
              <div class="none" id="sticky-hid-768" style="margin-top: 60px">
                <div class="p10 bg tc">
                </div>
                <div>
                  <center>
                ...
                <div class="row pt20 bg" style="">&nbsp;&nbsp;&nbsp;&nbsp;</div>
...
<!-- 
                <div class="bg4 p10" style="margin-top: -15px">
                  <div class="p10 bg5">
                        <span class="fa fa-bars p5 br1 pr10"></span><b class="ml5">CATEGORY</b>
                  </div>
                </div> -->
              ...
              <ul class="cw nav navbar-nav ml10 mt10 top-nav">
                <li class="p10">
                  <a href="{{URL::action('HomeController@index')}}"><span class="cw">HOME</span></a>
                </li>
                <li class="p10 mt15">
                  <div class="dropdown cw">
                    <div data-toggle="dropdown">
                      <span class="mr15"><b>CATEGORY</b></span>
                      <span class="caret"></span></button>
                    </div>
                    <ul class="dropdown-menu bg2">
                      @foreach($query->get_data('categories')->get() as $item)
                        <li class="ml10 pt10">
                          <span class="mr15">
                            <a href="{{URL::action('ProductController@category',['slug'=>$item->slug])}}" title="{{$item->name}}">{{$item->name}}</a>
                          </span>
                        </li>
                        @endforeach
                    </ul>
                ...
                <li class="p10">
                  <a href="{{URL::action('NewsController@index')}}" title="News"><span class="cw">NEWS</span></a>
                </li>
                <li class="p10">
                  <a href="{{URL::action('HomeController@page',['slug'=>'about-us'])}}"><span class="cw">ABOUT US</span></a>
                </li><!-- 
                <li class="p10">
                  <a href="contact.html"><span class="cw">CONTACT</span></a>
                </li> -->
                <li class="p10">
                  <a href="{{URL::action('HomeController@faqs')}}"><span class="cw">FAQs</span></a>
                </li>
              </ul>
        ...
        <div class="container-fluid container">
          ...
          <ul class="nav navbar-nav navbar-right top-nav f12 cb2" style="margin-top: 30px;">
            ...
            <div class="mr20 dropdown right br1 pr20">
              ...
              <ul class="dropdown-menu">
                <li class="ml10 pt10">
                  <span class="mr15">IDR</span>
                </li>
                <li class="ml10 pt10">
                  <span class="mr15">USD</span>
                </li>
                <li class="ml10 pt10">
                  <span class="mr15">EUR</span>
                </li>
              </ul>
            </div>
      ...
      <div class="row pt20 top-nav">
        <nav class="navbar">
            <div class="container-fluid container">
              <div class="navbar-header">
                <div class="dis768 ml20 pl20">
                  <img class="left" src="{{URL::asset('images/logo.png')}}" style="width: 60px">
                </div>
                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#collapse-1" aria-expanded="false">
                  <span class="sr-only">Toggle navigation</span>
                  <span class="fa fa-bars fa-2x"></span>
              ...
              <div class="collapse navbar-collapse nr" id="collapse-1">
                ...
                <ul class="nav navbar-nav ml10">
                  ...
                  <li class="mt15" style="font-weight: bold;">
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li class="ml10 pt10"><span class="mr15"><a href="{{URL::action('ProductController@index')}}" title="All Category">All Category</a></span></li>
                        @foreach($query->get_data('categories')->get() as $item)
                        <li class="ml10 pt10"><span class="mr15"><a href="{{URL::action('ProductController@category',['slug'=>$item->slug])}}" title="{{$item->name}}">{{$item->name}}</a></span></li>
                        @endforeach
                      </ul>
                    </div>
                  </li>
                  <li class="">
                    <a href="{{URL::action('NewsController@index')}}">NEWS</a>
                  </li>
                  <li class="">
                    <a href="{{URL::action('HomeController@page',['slug'=>'about-us'])}}">ABOUT US</a>
                  </li><!-- 
                  <li class="">
                    <a href="{{URL::action('HomeController@index')}}">CONTACT</a>
                  </li> -->
                  <li class="">
                    <a href="{{URL::action('HomeController@faqs')}}">FAQs</a>
                  </li>
                ...
                <ul class="nav navbar-nav navbar-right">
                  <li class="right mr20">
                    {!! Form::open(['action'=>'ProductController@search','method'=>'post']) !!}
                    <input type="text" class="p5" placeholder="Search Entire Store">
                    <div class="bg2 cw w40 right" style="height: 34px; text-align: center">
