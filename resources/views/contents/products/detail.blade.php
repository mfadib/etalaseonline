        ...
        <div class="container">
          <div class="col-md-12 p10">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="{{URL::action('ProductController@category',['slug'=>$query->get_field_data('categories',['id'=>$cat_id],'slug')])}}" class="cb">{{$query->get_field_data('categories',['id'=>$cat_id],'name')}}</a></li>
        ...
        <div class="col-md-4">
          <div class="p10 bordash">
            <div class="row mt20 tc">
              <div class="col-xs-6"><span class="fa fa-star fa-4x cr"></span><br/>FREE SHIPPING</div>
              <div class="col-xs-6"><span class="fa fa-television fa-4x cr"></span><br/>SAME DAY DISPATCH</div>
              <center><div class="row mt10" style="border-bottom: 1px solid #ddd; width: 90%;">&nbsp;</div></center>
            </div>
            <div class="p20 mt10 tj">
              <div class="">Avaibility: <span class="cr"><b>In Stock</b></span></div>
              <div class="f24 tc mt10"><b>{{$query->currency_format($pro->price)}}</b></div>
              <div class="mt10">Rating: {!!$query->get_rate($pro->id)!!}</div>
              <div class="mt20">Quick Overview:</div>
            ...
            <div class="col-xs-12 mt10">
  	          <a href="{{$shares['email']}}" title="{{$pro->title}}" ><div class="btn btn-default col-xs-3"><span class="fa fa-envelope-o fa-2x"></span></div></a>
  	          <a href="{{$shares['facebook']}}" title="{{$pro->title}}" ><div class="btn btn-default col-xs-3"><span class="fa fa-facebook fa-2x"></span></div></a>
  	          <a href="{{$shares['twitter']}}" title="{{$pro->title}}" ><div class="btn btn-default col-xs-3"><span class="fa fa-twitter fa-2x"></span></div></a>
  	          <a href="{{$shares['gplus']}}" title="{{$pro->title}}" ><div class="btn btn-default col-xs-3"><span class="fa fa-google-plus fa-2x"></span></div></a>
            </div>
            <br><br><br>
          </div>
        </div>
    ...
    <div class="row mt20"><!-- closing div on App.blade.php -->
      <div class="container"> <!-- closing div on App.blade.php -->
        ...
        <div class="tab-content p10 tj">
          <div id="home" class="tab-pane fade in active"><h3>Detail</h3>{!!$pro->description!!}</div>
          <div id="menu1" class="tab-pane fade"><h3>How to buy?</h3>{!! $pro->how_to_buy !!}</div>
          <div id="menu2" class="tab-pane fade"><h3>Reviews</h3>
          	@if($reviews->count() == 0)
              <div class="alert alert-info">product dont have reviews</div>
      			@else
          ...
          <div id="menu3" class="tab-pane fade"><h3>Send your review for this product</h3>
